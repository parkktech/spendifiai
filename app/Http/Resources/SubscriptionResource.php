...
class SubscriptionResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'missed_charge_at' => $this->missed_charge_at?->toIso8601String(),
            'recharged_at' => $this->recharged_at?->toIso8601String(),
            'recharged_amount' => $this->recharged_amount ? (float) $this->recharged_amount : null,
