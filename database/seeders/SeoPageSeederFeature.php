...
class SeoPageSeederFeature extends Seeder
{
    ...
    {
        $content = <<<'HTML'
<h2>How AI Transaction Categorization Works in SpendifiAI</h2>
...
<p>SpendifiAI solves this with AI-powered transaction categorization built on Anthropic's Claude, one of the most advanced large language models available. Instead of relying on rigid keyword matching, SpendifiAI understands context, merchant names, and spending patterns to classify your expenses with remarkable accuracy.</p>
...
<p>SpendifiAI takes a fundamentally different approach. Each transaction is analyzed by Claude AI, which considers the full merchant description, the transaction amount, your account type (business vs. personal), and historical patterns from your spending history.</p>

<h3>Confidence-Based Routing</h3>
<p>Not every transaction is equally easy to classify. SpendifiAI uses a four-tier confidence system to handle uncertainty intelligently:</p>
<ul>
...
<li><strong>Low confidence (40-59%):</strong> SpendifiAI generates a multiple-choice question, presenting the most likely categories for you to pick from.</li>
...
<blockquote><strong>Pro tip:</strong> Tagging your bank accounts as "business" or "personal" dramatically improves categorization accuracy. SpendifiAI uses account purpose as the strongest signal when classifying ambiguous transactions.</blockquote>

<h2>Learning From Your Corrections</h2>
<p>Every time you correct a category or answer an AI question, SpendifiAI gets smarter about your specific spending patterns. If you consistently recategorize "AMZN MKTP" from "Shopping" to "Office Supplies," the system learns that pattern for your account.</p>
...
<p>Accurate categorization is the foundation of every other feature in SpendifiAI. Your <a href="/features">budget tracking</a>, subscription detection, savings recommendations, and tax exports all depend on transactions being in the right categories. By getting this right with AI, everything downstream works better.</p>
<p>Ready to stop manually sorting receipts? <a href="/register">Create your free SpendifiAI account</a> and let AI handle your transaction categorization from day one.</p>
...
<p>SpendifiAI uses over 50 predefined categories mapped to IRS Schedule C tax lines. This standardized system ensures your expenses are tax-ready while covering virtually every type of personal and business expense.</p>
...
HTML;
        ...
        return [
            ...
            'title' => 'AI Transaction Categorization - Smart Expense Classification | SpendifiAI',
            'meta_description' => 'Learn how SpendifiAI uses Claude AI to automatically categorize your transactions with confidence-based routing, batch processing, and learning from your corrections.',
            ...
            'excerpt' => 'SpendifiAI uses Anthropic Claude AI to automatically categorize your transactions with a four-tier confidence system, learning from your corrections to improve over time.',
            'content' => $content,
            'faq_items' => json_encode([
                ...
                ['question' => 'Can I create custom categories?', 'answer' => 'SpendifiAI uses over 50 predefined categories mapped to IRS Schedule C tax lines. This standardized system ensures your expenses are tax-ready while covering virtually every type of personal and business expense.'],
    ...
    {
        $content = <<<'HTML'
<h2>How SpendifiAI Detects Your Forgotten Subscriptions</h2>
...
<p>SpendifiAI's automatic subscription detection scans your transaction history to find every recurring charge, including the ones you have completely forgotten about.</p>

<h2>Pattern Recognition, Not Guesswork</h2>
<p>SpendifiAI identifies subscriptions by analyzing the timing and amounts of your transactions. The system looks for charges that repeat at consistent intervals with consistent amounts, the two hallmarks of a subscription.</p>
...
<p>By allowing a tolerance window around each frequency, SpendifiAI catches subscriptions even when billing dates shift by a few days due to weekends or payment processing delays.</p>

<h2>Stopped Billing Detection</h2>
<p>One of SpendifiAI's most valuable features is detecting when a subscription has stopped billing. If you cancelled a service or if your card expired and a subscription lapsed, SpendifiAI flags it automatically.</p>
...
<blockquote><strong>Tip:</strong> Check your Subscriptions page after connecting a bank account with at least 90 days of transaction history. The more data SpendifiAI has, the more accurately it can identify recurring patterns.</blockquote>

<h2>Take Action on Every Subscription</h2>
<p>Finding subscriptions is only half the battle. SpendifiAI lets you take action on each one directly from the <a href="/features">Subscriptions dashboard</a>. For every detected subscription, you can:</p>
<ul>
...
<p>When you choose to reduce a subscription, SpendifiAI's AI suggests cheaper alternatives. Paying $15.99/month for a streaming service? The AI might suggest a lower-tier plan or a competitor offering similar content for less. These suggestions are cached for seven days and tailored to your actual usage patterns.</p>

<h2>Projected Savings Tracking</h2>
<p>Every subscription you cancel or reduce is tracked in your projected savings. SpendifiAI calculates exactly how much you will save over the next 12 months based on your decisions. This running total gives you a concrete, motivating number to see the real impact of cleaning up forgotten subscriptions.</p>
...
<p>New subscriptions are detected automatically as they appear in your transaction feed. You do not need to manually run detection. Every time your bank data syncs, SpendifiAI checks for new recurring patterns and alerts you to any changes.</p>
<p>Stop losing money to forgotten subscriptions. <a href="/register">Sign up for SpendifiAI</a> and discover exactly where your recurring charges are going.</p>

<h2>Frequently Asked Questions</h2>
<h3>How much transaction history does SpendifiAI need to detect subscriptions?</h3>
...
<h3>Will SpendifiAI cancel subscriptions for me?</h3>
<p>No. SpendifiAI identifies and tracks subscriptions, but cancellation must be done through the service provider. We provide the information and tracking so you know exactly what to cancel.</p>

<h3>Can SpendifiAI detect annual subscriptions?</h3>
...
HTML;
        ...
        return [
            ...
            'title' => 'Automatic Subscription Detection - Find Hidden Charges | SpendifiAI',
            'meta_description' => 'SpendifiAI automatically detects forgotten subscriptions using pattern recognition across weekly, monthly, quarterly, and annual billing cycles. Stop wasting money on unused services.',
            ...
            'excerpt' => 'SpendifiAI scans your transaction history to detect every recurring charge using pattern recognition across four billing frequencies, then helps you cancel or reduce what you do not need.',
            'content' => $content,
            'faq_items' => json_encode([
                ['question' => 'How much transaction history does SpendifiAI need to detect subscriptions?', 'answer' => 'At least 60-90 days of history provides the best results. Monthly subscriptions need at least two billing cycles to be detected as recurring.'],
                ['question' => 'Will SpendifiAI cancel subscriptions for me?', 'answer' => 'No. SpendifiAI identifies and tracks subscriptions, but cancellation must be done through the service provider. We provide the information and tracking so you know exactly what to cancel.'],
                ['question' => 'Can SpendifiAI detect annual subscriptions?', 'answer' => 'Yes, if you have at least 13 months of transaction history. Annual charges that repeat within a 350-380 day window are flagged as annual subscriptions.'],
                ['question' => 'What if a subscription changes its price?', 'answer' => 'SpendifiAI allows for small amount variations in its pattern matching. If the price change is significant, it may be detected as a new subscription while the old one is marked as stopped.'],
            ]),
            'is_published' => true,
            'published_at' => now(),
        ];
...
<p>Not every bank supports direct API connections, and not every user wants to link their bank credentials to a third-party service. SpendifiAI's bank statement upload feature gives you full access to AI-powered expense tracking without ever sharing your banking login.</p>
<p>Simply download your statement from your bank's website and upload the PDF or CSV file to SpendifiAI. Within minutes, every transaction is extracted, categorized, and ready for analysis.</p>

<h2>How Statement Parsing Works</h2>
<p>SpendifiAI supports two statement formats, each processed through a different pipeline optimized for accuracy.</p>
...
<p>SpendifiAI uses a two-stage process for PDFs. First, the raw text is extracted from the PDF document. Then, Claude AI analyzes the extracted text to identify individual transactions, their dates, descriptions, and amounts. The AI understands bank statement layouts intuitively, handling multi-line descriptions, running balances, and fee breakdowns that trip up traditional parsers.</p>
...
<p>SpendifiAI's AI examines the CSV structure, identifies the relevant columns, and normalizes the data into a consistent format. Whether your bank exports dates as "01/15/2026" or "2026-01-15" or "Jan 15, 2026," the AI handles it correctly.</p>
...
<p>SpendifiAI's statement upload wizard guides you through the process in three steps:</p>
<ul>
...
<li><strong>Step 2 - Review:</strong> SpendifiAI shows you the extracted transactions for verification. You can correct any parsing errors before importing.</li>
...
<p>Statement upload is the most privacy-conscious way to use SpendifiAI. Your bank credentials are never involved. The uploaded file is processed, the transactions are extracted, and you maintain complete control over what data enters the system.</p>
<p>This makes SpendifiAI accessible to users who bank with institutions not supported by Plaid, users in regions with limited open banking infrastructure, or anyone who simply prefers not to connect their bank electronically.</p>
...
<p>Statement uploads and <a href="/blog/plaid-bank-sync-feature">Plaid bank sync</a> work together seamlessly. You might connect your primary checking account via Plaid for automatic syncing while uploading statements from a secondary credit card that is not Plaid-supported. SpendifiAI merges all your transaction data into a single unified view regardless of how it was imported.</p>
...
<p>You do not need to connect a bank account to start using SpendifiAI. <a href="/register">Create your account</a>, upload a bank statement, and see AI-powered expense tracking in action within minutes.</p>

<h2>Frequently Asked Questions</h2>
<h3>What file formats are supported?</h3>
<p>SpendifiAI supports PDF and CSV bank statement formats. Most banks offer at least one of these formats for statement downloads.</p>
...
HTML;
        ...
        return [
            ...
            'title' => 'Bank Statement Upload - PDF & CSV Import | SpendifiAI',
            'meta_description' => 'Upload PDF or CSV bank statements to SpendifiAI for AI-powered transaction extraction and categorization. No bank login required. Full privacy control.',
            ...
            'excerpt' => 'Upload PDF or CSV bank statements to SpendifiAI and get instant AI-powered transaction extraction, categorization, and spending analysis without connecting your bank.',
            'content' => $content,
            'faq_items' => json_encode([
                ['question' => 'What file formats are supported?', 'answer' => 'SpendifiAI supports PDF and CSV bank statement formats. Most banks offer at least one of these formats for statement downloads.'],
                ...
                ['question' => 'Will duplicate transactions be created if I upload overlapping statements?', 'answer' => 'SpendifiAI includes duplicate detection that identifies overlapping transactions when you upload statements covering periods already synced via Plaid or previous uploads.'],
            ]),
            'is_published' => true,
            'published_at' => now(),
        ];
...
<p>SpendifiAI's AI savings engine analyzes 90 days of your spending history to find specific, actionable ways to reduce your expenses. Not generic advice like "eat out less." Real recommendations tied to your actual spending patterns with projected dollar amounts.</p>

<h2>The 90-Day Spending Analysis</h2>
<p>When you request savings recommendations, SpendifiAI sends your last 90 days of categorized transactions to Claude AI for deep analysis. The AI examines spending patterns across every category, looking for:</p>
<ul>
...
<p>Each savings recommendation comes with concrete action steps. Instead of saying "reduce subscription spending," SpendifiAI might say:</p>
<ul>
...
<ul>
<li><strong>Cancel:</strong> You will eliminate this expense entirely. SpendifiAI tracks the full amount as projected savings.</li>
<li><strong>Reduce:</strong> You will cut back but not eliminate. The AI suggests a realistic target amount.</li>
<li><strong>Keep:</strong> This expense stays as-is. SpendifiAI respects your priorities and focuses on other areas.</li>
</ul>
...
<p>Beyond individual recommendations, you can set a savings target with a deadline. SpendifiAI's AI creates a personalized plan to hit your goal, breaking it down into monthly milestones and specific actions. Want to save $5,000 for a vacation in 8 months? The AI calculates you need $625/month and identifies exactly where that money can come from in your current spending.</p>

<h2>Monthly Savings Ledger</h2>
<p>SpendifiAI tracks your actual savings month by month with a savings ledger. You can see claimed savings (what you committed to) versus verified savings (confirmed by comparing your actual spending to previous months). This accountability system turns good intentions into measurable results.</p>
...
<p>When you choose to reduce an expense rather than eliminate it, SpendifiAI suggests cheaper alternatives. These AI-generated suggestions are specific to the service or product you are currently paying for, giving you a direct replacement path rather than vague advice to "shop around."</p>

<h2>Start Saving Smarter</h2>
<p>Stop guessing where to cut back. <a href="/register">Create your SpendifiAI account</a> and let AI analyze your spending to find real savings opportunities backed by your actual data.</p>
...
<h3>Does SpendifiAI automatically cancel services for me?</h3>
<p>No. SpendifiAI identifies savings opportunities and tracks your progress, but you take action on your own terms. We provide the insight; you make the decisions.</p>
...
HTML;
        ...
        return [
            ...
            'title' => 'AI Savings Recommendations - Find Money in Your Budget | SpendifiAI',
            'meta_description' => 'SpendifiAI analyzes 90 days of spending to find personalized savings opportunities with projected dollar amounts, action steps, and monthly progress tracking.',
            ...
            'excerpt' => 'SpendifiAI analyzes 90 days of your spending to deliver personalized savings recommendations with specific action steps, projected savings amounts, and monthly progress tracking.',
            'content' => $content,
            'faq_items' => json_encode([
                ...
                ['question' => 'Does SpendifiAI automatically cancel services for me?', 'answer' => 'No. SpendifiAI identifies savings opportunities and tracks your progress, but you take action on your own terms. We provide the insight; you make the decisions.'],
                ...
                ['question' => 'Can I set a specific savings goal?', 'answer' => 'Yes. SpendifiAI lets you set a savings target with a deadline. The AI creates a personalized plan with monthly milestones and specific actions to help you reach your goal.'],
            ]),
            'is_published' => true,
            'published_at' => now(),
        ];
...
<p>Tax season does not have to mean a frantic scramble through bank statements and shoebox receipts. SpendifiAI organizes your deductible expenses throughout the year and exports them in the exact format your accountant needs.</p>
...
<p>SpendifiAI's 50+ expense categories are not arbitrary labels. Each one maps directly to an IRS Schedule C line item, the tax form used by sole proprietors and freelancers to report business income and expenses.</p>
...
<p>If you have tagged your bank accounts with account purposes (business, personal, or mixed), SpendifiAI uses this to filter your tax export automatically. Only business-purpose transactions appear in your deduction export, preventing personal expenses from inflating your reported deductions.</p>
...
<p>SpendifiAI generates your tax deduction report in three formats to suit different workflows:</p>
...
<p>The best time to organize your tax deductions is not April. It is every day. With SpendifiAI's AI categorization running continuously, your deductions are organized in real time as transactions flow in. When tax season arrives, you export and you are done.</p>
<p><a href="/register">Sign up for SpendifiAI</a> and make next tax season the easiest one yet.</p>

<h2>Frequently Asked Questions</h2>
<h3>Does SpendifiAI work for W-2 employees or only freelancers?</h3>
...
HTML;
        ...
        return [
            ...
            'title' => 'Tax Deduction Export - Excel, PDF & CSV Reports | SpendifiAI',
            'meta_description' => 'Export your tax deductions to Excel, PDF, or CSV with IRS Schedule C mapping. SpendifiAI organizes expenses by tax line and emails reports directly to your accountant.',
            ...
            'excerpt' => 'SpendifiAI maps your categorized expenses to IRS Schedule C tax lines and exports them to Excel, PDF, or CSV. Email reports directly to your accountant with one click.',
            'content' => $content,
            'faq_items' => json_encode([
                ['question' => 'Does SpendifiAI work for W-2 employees or only freelancers?', 'answer' => 'While the Schedule C mapping is designed for self-employed individuals and freelancers, the expense categorization and export features are useful for anyone who itemizes deductions or needs to track business expenses.'],
                ...
                ['question' => 'Can I email the export directly to my accountant?', 'answer' => 'Yes. SpendifiAI can email your tax export directly to your accountant with a professional cover message, saving you the step of downloading and forwarding.'],
            ]),
            'is_published' => true,
            'published_at' => now(),
        ];
...
<p>Manually importing transactions is a chore nobody looks forward to. SpendifiAI integrates with Plaid, the same secure banking infrastructure used by Venmo, Robinhood, and thousands of other financial apps, to sync your bank transactions automatically.</p>
<p>Connect your bank once, and every new transaction flows into SpendifiAI automatically. No downloads, no uploads, no manual data entry.</p>

<h2>What Is Plaid and Why We Use It</h2>
<p>Plaid is a financial technology company that provides the secure connection layer between your bank and apps like SpendifiAI. When you connect your bank through SpendifiAI, you are actually authenticating directly with Plaid's infrastructure. SpendifiAI never sees your bank login credentials.</p>
...
<ul>
<li><strong>Step 1:</strong> Click "Connect Bank" on the SpendifiAI Connect page. A secure Plaid Link window opens.</li>
<li><strong>Step 2:</strong> Search for your bank and log in with your banking credentials inside the Plaid window. SpendifiAI cannot see these credentials.</li>
<li><strong>Step 3:</strong> Select which accounts to connect (checking, savings, credit cards). You choose what to share.</li>
<li><strong>Step 4:</strong> Plaid establishes the connection and SpendifiAI syncs your recent transaction history.</li>
</ul>
...
<blockquote><strong>Tip:</strong> Connect all your financial accounts, including credit cards, for the most complete picture of your spending. SpendifiAI's AI categorization and subscription detection work best with comprehensive transaction data.</blockquote>

<h2>Bank-Level Security</h2>
<p>Security is not an afterthought with Plaid. Your connection is protected by multiple layers:</p>
<ul>
<li><strong>End-to-end encryption:</strong> All data transmitted between your bank, Plaid, and SpendifiAI is encrypted in transit and at rest.</li>
<li><strong>Token-based access:</strong> SpendifiAI stores an encrypted access token, not your bank credentials. This token can be revoked at any time.</li>
<li><strong>Read-only access:</strong> The Plaid connection only reads transaction data. SpendifiAI cannot move money, make payments, or modify your bank accounts in any way.</li>
...
<p>You can disconnect any bank connection from SpendifiAI at any time. Disconnecting immediately revokes the access token and stops all future data syncing. Your previously imported transactions remain in SpendifiAI, but no new data flows in.</p>

<h2>Webhook-Driven Updates</h2>
<p>SpendifiAI does not poll your bank on a timer. Instead, Plaid sends webhook notifications whenever new transactions are available. This means your data updates faster and more efficiently. The webhook system handles three key events:</p>
<ul>
<li><strong>New transactions available:</strong> Fresh transactions are synced automatically</li>
<li><strong>Login required:</strong> If your bank requires re-authentication, SpendifiAI alerts you</li>
...
<p><a href="/register">Create your SpendifiAI account</a> and connect your first bank in less than 60 seconds. Automatic transaction syncing starts immediately.</p>
...
<h3>Can SpendifiAI access my bank login credentials?</h3>
<p>No. You authenticate directly with Plaid's secure window. SpendifiAI only receives an encrypted access token that allows read-only transaction access. Your username and password are never shared with SpendifiAI.</p>

<h3>What happens if my bank requires re-authentication?</h3>
<p>Some banks periodically require you to re-enter your credentials for security. When this happens, SpendifiAI alerts you and provides a simple re-authentication flow through Plaid Link.</p>
HTML;

        return [
            'slug' => 'plaid-bank-sync-feature',
            'title' => 'Secure Bank Sync via Plaid - Automatic Transaction Import | SpendifiAI',
            'meta_description' => 'SpendifiAI uses Plaid to securely sync bank transactions automatically. Read-only access, end-to-end encryption, and support for 12,000+ institutions.',
            ...
            'excerpt' => 'SpendifiAI uses Plaid to securely sync your bank transactions automatically with read-only access, encrypted tokens, and support for over 12,000 financial institutions.',
            'content' => $content,
            'faq_items' => json_encode([
                ...
                ['question' => 'Can SpendifiAI access my bank login credentials?', 'answer' => 'No. You authenticate directly with Plaid\'s secure window. SpendifiAI only receives an encrypted access token for read-only transaction access.'],
                ['question' => 'What happens if my bank requires re-authentication?', 'answer' => 'Some banks periodically require credential re-entry. SpendifiAI alerts you and provides a simple re-authentication flow through Plaid Link.'],
                ['question' => 'Can I disconnect my bank at any time?', 'answer' => 'Yes. Disconnecting immediately revokes the access token and stops all future data syncing. Your previously imported transactions remain in SpendifiAI.'],
            ]),
            'is_published' => true,
            'published_at' => now(),
        ];
...
<p>SpendifiAI's budget waterfall dashboard visualizes your money flow as a cascading chart that makes your financial picture immediately understandable at a glance.</p>
...
<p>The waterfall chart is the centerpiece of the SpendifiAI dashboard, but it is surrounded by additional financial insight blocks that provide a complete picture of your finances.</p>
...
<p>SpendifiAI uses standard lending ratios applied to your actual income and expenses. The front-end ratio (28% of gross income for housing) and back-end ratio (36% for total debt) provide a realistic estimate based on your data.</p>
HTML;

        return [
            'slug' => 'budget-waterfall-dashboard',
            'title' => 'Budget Waterfall Dashboard - Visual Spending Tracker | SpendifiAI',
            'meta_description' => 'SpendifiAI\'s budget waterfall dashboard visualizes your income flowing through expense categories. See your complete financial picture at a glance with real-time data.',
            ...
            'excerpt' => 'SpendifiAI\'s budget waterfall dashboard visualizes your money flowing from income through each spending category, giving you instant clarity on where every dollar goes.',
            'content' => $content,
            'faq_items' => json_encode([
                ...
                ['question' => 'How is the home affordability calculated?', 'answer' => 'SpendifiAI uses standard lending ratios (28% front-end, 36% back-end) applied to your actual income and expenses for a realistic estimate.'],
    ...
    {
        $content = <<<'HTML'
<h2>How SpendifiAI Asks Smart Categorization Questions</h2>
...
<p>SpendifiAI's AI question system handles ambiguous transactions by asking you intelligently crafted questions instead of silently miscategorizing your expenses or leaving them uncategorized entirely.</p>
...
<p>SpendifiAI takes a third approach. When the AI's confidence in a categorization falls below a threshold, it generates a targeted question. The question is designed to resolve the ambiguity with minimal effort from you.</p>
...
<p>For transactions in the 40-59% confidence range, SpendifiAI presents the top candidate categories as multiple-choice options. The AI has a reasonable idea of what the transaction might be but needs you to confirm.</p>
...
<p>For transactions below 40% confidence, the description is too cryptic for even probable categories. SpendifiAI asks an open-ended question: "What was this transaction for?" You type a brief description, and the AI uses your response to categorize it correctly.</p>
...
<p>Every answered question teaches SpendifiAI about your specific spending patterns. The system remembers that "SQ *JOES COFFEE" is a dining expense for you, that "AMZN MKTP" is usually office supplies for your business, and that "PAYPAL *INST" transactions from a specific merchant are software subscriptions.</p>
...
<p>Accurate expense tracking starts with accurate categorization. <a href="/register">Sign up for SpendifiAI</a> and experience AI questions that turn ambiguous transactions into clean, organized financial data.</p>
...
HTML;
        ...
        return [
            ...
            'title' => 'AI Expense Questions - Smart Transaction Clarification | SpendifiAI',
            'meta_description' => 'SpendifiAI asks intelligently crafted questions about ambiguous transactions instead of guessing. Multiple choice, open-ended, and chat-based clarification for perfect categorization.',
            ...
            'excerpt' => 'When transactions are ambiguous, SpendifiAI asks smart questions instead of guessing. Multiple-choice, open-ended, and chat-based clarification ensures every expense is correctly categorized.',
            'content' => $content,
            'faq_items' => json_encode([
                ...
                ['question' => 'Does answering questions improve future categorization?', 'answer' => 'Yes. Every answered question teaches SpendifiAI about your specific spending patterns. Over time, the AI generates fewer questions as it learns your habits.'],
            ]),
            'is_published' => true,
            'published_at' => now(),
        ];
...
<p>Your financial data is some of the most sensitive information you own. Bank account numbers, transaction histories, income patterns, and tax deductions paint a complete picture of your financial life. SpendifiAI treats this data with the security it deserves.</p>
<p>From encrypted storage to two-factor authentication, every layer of SpendifiAI is designed to protect your financial privacy.</p>

<h2>Two-Factor Authentication (2FA)</h2>
<p>Two-factor authentication adds a second verification step beyond your password. Even if someone obtains your password through a data breach or phishing attack, they cannot access your SpendifiAI account without the second factor.</p>

<h3>How 2FA Works in SpendifiAI</h3>
<p>SpendifiAI uses Time-based One-Time Passwords (TOTP), the same standard used by Google, Microsoft, and major banks. Here is how to set it up:</p>
<ul>
...
<p>When you enable 2FA, SpendifiAI generates a set of recovery codes. These one-time-use codes let you access your account if you lose your authenticator device. Store them somewhere safe, like a password manager or a printed copy in a secure location.</p>
...
<p>SpendifiAI encrypts sensitive data both in transit and at rest. Here is what that means in practice:</p>

<h3>Data in Transit</h3>
<p>All communication between your browser and SpendifiAI servers uses TLS encryption (HTTPS). This prevents anyone on your network from intercepting your financial data, even on public Wi-Fi.</p>
...
<p>Beyond 2FA, SpendifiAI implements several authentication security measures:</p>
...
<p>SpendifiAI uses Laravel Sanctum for API authentication with bearer tokens. Tokens are scoped, revocable, and expire after inactivity. This is more secure than traditional session cookies for API-driven applications.</p>

<h3>Google OAuth</h3>
<p>For users who prefer not to manage another password, SpendifiAI supports Google OAuth login. This delegates authentication to Google's infrastructure, which includes its own 2FA, suspicious login detection, and account recovery mechanisms.</p>

<h2>Privacy by Design</h2>
<p>Every model in SpendifiAI that contains sensitive data has hidden fields configured to prevent accidental API exposure. Even if a developer error were to return a full model object, sensitive fields like tokens, secrets, and encrypted data would be automatically stripped from the response.</p>
<p>SpendifiAI also maintains comprehensive <a href="/privacy">privacy</a> and <a href="/data-retention">data retention</a> policies that explain exactly what data is collected, how it is used, and when it is deleted.</p>

<h2>Protect Your Financial Data</h2>
<p><a href="/register">Create your SpendifiAI account</a> and enable two-factor authentication in under a minute. Your financial data deserves enterprise-grade security.</p>
...
HTML;
        ...
        return [
            ...
            'title' => 'Two-Factor Authentication & Security Features | SpendifiAI',
            'meta_description' => 'SpendifiAI protects your financial data with TOTP two-factor authentication, AES-256 encryption, rate-limited logins, and privacy-by-design architecture.',
            ...
            'excerpt' => 'SpendifiAI protects your financial data with TOTP two-factor authentication, AES-256 encryption at rest, rate-limited authentication, and privacy-by-design architecture.',
            'content' => $content,
            'faq_items' => json_encode([
...
<p>SpendifiAI connects to your email through two methods:</p>
<ul>
<li><strong>Google OAuth:</strong> For Gmail users, a secure OAuth connection grants read-only access to your inbox. SpendifiAI can only read emails; it cannot send, delete, or modify anything.</li>
...
<p>SpendifiAI scans your inbox for emails that look like purchase receipts. Not every email from a retailer is a receipt. The system distinguishes between order confirmations, shipping notifications, marketing emails, and actual purchase receipts using AI-powered classification.</p>
...
<blockquote><strong>Tip:</strong> Connect your email early, even before you have a full transaction history. SpendifiAI stores parsed receipts and matches them retroactively when the corresponding bank transactions are imported later.</blockquote>

<h3>Stage 4: Transaction Matching</h3>
<p>Parsed receipts are matched to bank transactions using amount, date, and merchant name. When a receipt for $47.82 from Amazon on January 15th matches a bank charge of $47.82 from "AMZN MKTP US" on January 15th, SpendifiAI links them together.</p>
...
<p>Bank transactions are blunt instruments. A $200 Target charge could be groceries, clothing, electronics, or all three. Without the receipt, there is no way to know. With email receipt matching, SpendifiAI splits that single transaction into its component purchases and categorizes each one separately.</p>
...
<p>Email access is strictly read-only. SpendifiAI cannot send emails, delete messages, or modify your inbox in any way. OAuth tokens and IMAP credentials are encrypted at rest using AES-256 encryption. You can disconnect your email at any time, and previously parsed receipts remain in your account for reference.</p>

<h2>Connect Your Email and See the Full Picture</h2>
<p>Bank transactions show you where money went. Email receipts show you what you bought. <a href="/register">Create your SpendifiAI account</a> and connect your email to unlock item-level spending visibility.</p>
...
<h3>Does SpendifiAI read all my emails?</h3>
<p>No. SpendifiAI only scans for emails that match receipt patterns from known merchants. Personal emails, newsletters, and other non-receipt messages are ignored.</p>
...
HTML;
        ...
        return [
            ...
            'title' => 'Email Receipt Matching - Item-Level Transaction Detail | SpendifiAI',
            'meta_description' => 'SpendifiAI automatically matches email receipts to bank transactions, adding item-level detail to your spending data. AI-parsed receipts from Gmail and IMAP providers.',
            ...
            'excerpt' => 'SpendifiAI connects your email to automatically parse purchase receipts with AI, matching them to bank transactions for item-level spending detail and better tax deduction tracking.',
            'content' => $content,
            'faq_items' => json_encode([
                ...
                ['question' => 'Does SpendifiAI read all my emails?', 'answer' => 'No. SpendifiAI only scans for emails that match receipt patterns from known merchants. Personal emails and newsletters are ignored.'],
