...
<body>
    <div class="header">
        <h1>Tax Deduction Report — {{ $year }}</h1>
        <p>Prepared for {{ $user->name }} via SpendWise AI Expense Tracker</p>
    </div>
    ...
    <div class="content">
        ...
        <p>
            ...
            This package was generated by SpendWise and includes AI-categorized expense data
        ...
        <div class="files">
            ...
            <div class="file-item">
                ...
                <span><strong>SpendWise_Tax_{{ $year }}.xlsx</strong> — Full workbook with 5 tabs: Summary, Schedule C Mapping, Categories, Transaction Detail, Subscriptions</span>
            </div>
            <div class="file-item">
                <span class="file-icon" style="background: #c62828;">PDF</span>
                <span><strong>SpendWise_Tax_Summary_{{ $year }}.pdf</strong> — Printable cover sheet with Schedule C mapping and category totals</span>
            </div>
            <div class="file-item">
                <span class="file-icon" style="background: #2e7d32;">CSV</span>
                <span><strong>SpendWise_Transactions_{{ $year }}.csv</strong> — Raw transaction data for import into tax software</span>
            </div>
        </div>
        ...
        <div class="disclaimer">
            ...
            verified by the taxpayer. Transactions marked "✓ User" were manually confirmed.
            This report is not tax advice. Please review all categorizations before filing.
            <br><br>
            Generated by <strong>SpendWise</strong> on {{ $summary['generated_at'] }}
        </div>
    </div>
</body>
</html>
