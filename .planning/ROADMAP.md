...
**Plans**: TBD
**UI hint**: yes
> Scope expanded 2026-07-01 by tax-playbook integration (15→~30 reqs). Execute as two waves within the phase: wave 11a = detector/interview/storage infrastructure, wave 11b = detector content. See .planning/reference/INTEGRATION-MAP.md.
