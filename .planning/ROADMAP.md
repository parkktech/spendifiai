...
**Requirements**: FLAG-01, FLAG-02, FLAG-03, FLAG-04, FLAG-05, FLAG-06, FLAG-07, FLAG-08, FLAG-09, FLAG-10, FLAG-11, FLAG-12, FLAG-13, FLAG-14, FLAG-15, FLAG-16, FLAG-17, FLAG-18, FLAG-20, FLAG-21, FLAG-22, FLAG-23, FLAG-24, FLAG-25, FLAG-26, FLAG-27, FLAG-28, INT-01, INT-02, INT-03, INT-04, INT-05, INT-06, INT-07, FEED-01, FEED-02, FEED-03, FEED-04, TAX-08, TAX-09, STORE-01, STORE-02
**Success Criteria** (what must be TRUE):
...
- [x] 11-04-PLAN.md — Interview orchestrator + AI-feed bridge (INT-01/04/05/06/07, FEED-01..04)
- [x] 11-05-PLAN.md — Interview UI + suggested-confirm + Settings learned-facts (INT-02) [frontend]
- [x] 11-06-PLAN.md — Core detectors + profile-vs-reality conformance + audit-risk (FLAG-02/03/04/05/14/15/28)
- [x] 11-07-PLAN.md — Merchant category library + sweeps + retroactive scanners + safe-harbor benchmark + life events (FLAG-07/10/11/12/18/26/27)
- [x] 11-08-PLAN.md — Probe matrix + W-2 benefits + alarms + ACA cliff + refundable credits (FLAG-16/17/20/21/22/23/24/25)
...
**Requirements**: RPT-01, RPT-02, RPT-03, RPT-04, RPT-05, RPT-06, RPT-07, RPT-08, DOC-01, DOC-02, DOC-03, DOC-05, DOC-06, DOC-07, UI-01, UI-02, UI-03, STORE-03
**Success Criteria** (what must be TRUE):
...
- [x] 14-01-PLAN.md — Scenario config foundations + D17 AI cost discipline (SCN-03)
- [x] 14-02-PLAN.md — TaxRulesEngineService SCN-01..07 pure methods + ACA invariant (SCN-04)
- [x] 14-03-PLAN.md — ScenarioFactResolverService + ScenarioFactSet (SCN-02)
- [x] 14-04-PLAN.md — Design Elevation Wave 1: 41 tokens + app shell (ELEV-01)
- [x] 14-05-PLAN.md — ObjectiveReadinessService + interview additive + objectives API (SCN-01)
...
- [x] 14-10-PLAN.md — Phase-14 frontend: Action Center UI + scenarios + checklist + ELEV-03 (ACT-01, ACT-05, ELEV-03)
...
- [ ] 13-01-PLAN.md — SAFE-01 framing audit: BannedPhraseSystemPromptsTest + FramingReviewPinTest + 12-call-site worksheet (SAFE-01, SAFE-05, SAFE-07)
...
- [ ] 13-03-PLAN.md — SAFE-02/04/07 injection pen-test: schema-whitelist output validation + `<document_content>` delimiters + SSN-masking audit (SAFE-02, SAFE-04, SAFE-07)
...
| 13. Safety, Validation & Hardening | v2.1 | 0/4 | Not started | - |
